...
// Stolen from: https://github.com/joseluisct/AppLoopback/blob/38cfc1eac6cc2b3d12f27d8bde33de69b48a0805/ProcLoopback/WasapiCapture.cs
// Ref 1: https://github.com/joseluisct/AppLoopback/tree/38cfc1eac6cc2b3d12f27d8bde33de69b48a0805/ProcLoopback
// Ref 2: https://github.com/naudio/NAudio/issues/878
...
public class ProcessWasapiCapture : IWaveIn
{
    ...
    /// </summary>
    public ProcessWasapiCapture() : this(GetDefaultCaptureDevice())
    {
    }
    ...
    public ProcessWasapiCapture(MMDevice captureDevice) : this(captureDevice, false)
    {
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="ProcessWasapiCapture"/> class.
    /// </summary>
    /// <param name="captureDevice">The capture device.</param>
    /// <param name="useEventSync">true if sync is done with event. false use sleep.</param>
    public ProcessWasapiCapture(MMDevice captureDevice, bool useEventSync) : this(captureDevice, useEventSync, 100)
    {
    }
    ...
    public ProcessWasapiCapture(MMDevice captureDevice, bool useEventSync, int audioBufferMillisecondsLength) : this(captureDevice.AudioClient, useEventSync, audioBufferMillisecondsLength)
    {
    }
    ...
    private ProcessWasapiCapture(AudioClient audioClient, bool useEventSync, int audioBufferMillisecondsLength)
    {
        ...
        audioClientStreamFlags = AudioClientStreamFlags.AutoConvertPcm | AudioClientStreamFlags.SrcDefaultQuality;
    ...
    public static async Task<ProcessWasapiCapture> CreateForProcessCaptureAsync(int processId, bool includeProcessTree, int bufferFrameCount = 2000)
    {
    ...
    private void ReadNextPacket(AudioCaptureClient capture)
    {
        ...
        while (packetSize != 0)
        {
            nint buffer = capture.GetBuffer(out int framesAvailable, out AudioClientBufferFlags flags);
