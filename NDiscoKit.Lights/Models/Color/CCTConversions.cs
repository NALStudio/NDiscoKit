...
public partial struct NDKColor
{
    ...
    public static class FromCCT
    {
        ...
        /// </param>
        public static NDKColor Daylight(double T, double brightness = 1d)
        {
            ...
            return new NDKColor(x, y, brightness);
        }
        ...
        /// The correlated color temperature in kelvin.
        /// </param>
        public static NDKColor BlackBody(double T, double brightness = 1d)
        {
